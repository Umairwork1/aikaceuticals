export const es = {
  translation: {
    ...
    'HD Used Machines': 'Máquinas Usadas HD',
    Contact: 'Contacto',
    ...
    logistic_description4: `Nuestra gama de productos incluye dializadores, conjuntos AV, fístulas
                              AV y soluciones de diálisis en formas líquidas y en polvo, que se
                              gestionan y suministran a nuestros socios distribuidores en todo el
                              mundo desde nuestra sede en Estambul de forma permanente.`,
    logistic_description5: `Servicio en el punto de uso, servicio de carrito y servicio de
                              estanterías. También ofrecemos una solución de gestión de inventario
                              llamada Aikaceuticals Company Stock y dispensadores de equipos de
                              protección personal para productos desechables. Nuestros servicios
                              ayudan a las instalaciones de salud a ahorrar tiempo y dinero,
                              permitiéndoles enfocarse en lo que mejor hacen: cuidar a sus
                              pacientes.`,

    spare_parts_heading: 'Repuestos para Sistemas de Hemodiálisis',
    spare_parts_description1: `Asegura el funcionamiento ininterrumpido de tu equipo de diálisis con
                                    nuestra amplia selección de repuestos para máquinas de hemodiálisis.
                                    Suministramos componentes compatibles de alta calidad para marcas
                                    líderes como Fresenius, B. Braun, Nipro, Gambro y más.`,
    spare_parts_description2: `Piezas OEM y compatibles disponibles`,
    spare_parts_description3: `Envío rápido a nivel mundial`,
    spare_parts_description4: `Orientación técnica y soporte`,
    spare_parts_description5: `Stock para modelos antiguos y más recientes`,
    spare_parts_description6: `Operando desde instalaciones tanto en Europa como en Turquía, nos
                                    especializamos en producir nuestra propia marca de consumibles de
                                    diálisis, que incluyen desechables básicos como dializadores, líneas
                                    de sangre, agujas de fístula, cartuchos de bicarbonato, así como la
                                    fabricación y distribución de polvos y soluciones líquidas para
                                    hemodiálisis. Brindamos apoyo directo a centros de diálisis,
                                    hospitales y empresas asociadas, asegurando el cumplimiento de los
                                    requisitos de licitación`,
    spare_parts_description7: `Desde bombas de sangre y sensores hasta válvulas, abrazaderas y
                                    pantallas táctiles: tenemos lo que necesitas para mantener tus
                                    máquinas funcionando al máximo rendimiento.`,
    ...
    contact_us_description2: `Nos pondremos en contacto contigo lo antes posible.`,
    ...
    message_sent_success_message:
      'Tu mensaje ha sido recibido por el administrador y te contactaremos lo antes posible.',
